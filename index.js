...
// var numClients = (typeof clients !== 'undefined') ? Object.keys(clients).length : 0;
 ...
 //        // //[//console.log(socket.nickname)
        socket.ishost = socket.id;
        random_num = Math.floor(Math.random() * 965) + 1  
